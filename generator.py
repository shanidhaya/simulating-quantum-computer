...
# Import the instruction parser from your circuit engine
...
def generate_random_circuit(num_qubits: int, num_layers: int, qubits: list[int] = None):
    ...
    # Standard 1-qubit gates available in your dictionary
...
if __name__ == "__main__":
    # Small test block to verify the generator runs independently
    num_q = 3
    num_l = 4
